...
def process_comarca(comarca, comarcas_visitados):
    comarca_value = comarca.get_attribute('value')
    if not comarca_value or comarca.get_attribute('innerHTML') in comarcas_visitados:
        return
...
def main():
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor:
        futures = [executor.submit(process_comarca, comarca, comarcas_visitados) for comarca in comarcas]
