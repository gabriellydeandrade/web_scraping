...
def process_comarca(comarca, comarcas_visitadas_lock, comarcas_visitadas):
...
def main():
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor:
        futures = [executor.submit(process_comarca, comarca, comarcas_visitadas_lock, comarcas_visitadas) for comarca in comarcas]
